...
<script>
	...
	document.getElementById("goToLink").addEventListener("click", function() {
		window.location.href = "/WebProject"; // 이동할 링크를 지정
	});
</script>
		...
		<div class="layout">
			<aside class="lnb-layout">
				<ul class="sub-menu col5">
					...
					<li class="sub-item"><a href="../login.jsp"> <span>회원정보
								수정</span>
					</a></li>
				</ul>
			</aside>
				...
				<form method="post" id="b">
					<table class="board-table" style="width: 80%; margin: 0 auto;">
						<tr class="visual-tbody">
							<td style="font-size: 30px;" class="Id th">이름 :</td>
							<td class="Id1 th"><input style="font-size: 30px;"
								type="text" id="user_name" name="user_name"
								value="${user.user_name }" readonly="readonly" /></td>
						</tr>
						<tr class="visual-tbody">
							<td style="font-size: 30px;" class="pass th">새로운 패스워드 :</td>
							<td class="pass1 td"><input
