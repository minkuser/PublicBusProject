...
public class QBoardController {
	...
	public String selectQBoardList(@RequestParam(value = "typeCondition", required = false) String typeCondition,
			@ModelAttribute("searchVO") QBoardDefaultVO searchVO, ModelMap model, HttpSession session) throws Exception {
	...
	public String selectQBoard(HttpSession session, QBoardVO vo, Model model) throws Exception {
		...
		} else if(!user.getUser_id().equals("ad")){
	...
	public String selectQReply(QBoardVO vo, Model model, HttpSession session) throws Exception {
		UserVO user = (UserVO)session.getAttribute("user");
