...
.button-container>div {
	margin: 40px; /* Adjust this margin for the desired gap */
	display: flex;
			...
			<aside class="lnb-layout">
				<ul class="sub-menu col5">
					...
					<li class="sub-item current"><a
						href="selectQBoardList.do"> <span>문의게시판</span>
					</a></li>
				</ul>
			</aside>
...
<%-- 									<tr class="point">
								...
								<tr>
									...
									<td style="font-size: 30px" class="file1 th"><a
										href="fileDownload.do?fileName=${QBoard.fileName}"> <input
											...
											value="${QBoard.fileName}" name="fileName"
							...
							<tr>
								...
								<td class="down1 th"><input
									style="background-color: #F8F8F8;" type="file"
									name="uploadFile"
						...
						<div class="button-container"
							...
							<c:if test="${sessionId ne 'ad'}">
								<c:if test="${sessionId eq QBoard.users}">
									<button
										style="width: 100px; display: inline-block; border: 1px solid; padding: 15px 30px; border-radius: 15px; margin-top: 20px;"
										onclick="redirectToInsertQBoard()">새글</button>
									<script>
										function redirectToInsertQBoard() {
											window.location.href = './insertQBoard.jsp';
										}
									</script>
